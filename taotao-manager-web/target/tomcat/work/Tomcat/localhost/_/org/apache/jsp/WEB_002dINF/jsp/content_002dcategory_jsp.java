 ...
 * Generated at: 2020-03-12 03:36:22 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\turl : '/content/category/list',\t\t//初始化树形视图\r\n");
      out.write("\t\tanimate: true,\r\n");
      out.write("\t\tmethod : \"GET\",\r\n");
      out.write("\t\t/* onContextMenu监听事件 */\r\n");
      out.write("\t\t/*  e是事件对象  node是对应单击右键的节点*/\r\n");
      out.write("\t\tonContextMenu: function(e,node){\r\n");
      out.write("            e.preventDefault();\r\n");
      out.write("            \t\t\t/*把当前节点变成选择状态  */\r\n");
      ...
      out.write("            });\r\n");
      out.write("        },\t//创新新节点对象后,鼠标离开后触发事件(编辑完成后会触发事件)\r\n");
      out.write("        onAfterEdit : function(node){\r\n");
      out.write("        \tvar _tree = $(this);\r\n");
      out.write("        \tif(node.id == 0){//判断是否为新节点 (新节点id为0)\r\n");
      out.write("        \t\t// 新增节点 写入后台\r\n");
      ...
      out.write("            \t\t\t\tid : data.data.id  //更新id id不为0了\r\n");
      out.write("            \t\t\t});\r\n");
      out.write("        \t\t\t}else{\r\n");
      ...
      out.write("        \t\t});\r\n");
      out.write("        \t}else{\r\n");
      out.write("        \t\t//从命名后触发 即 id不为0时  更新数据库\r\n");
      ...
      out.write("});\r\n");
      out.write("\r\n");
      out.write("/* 点击菜单后,触发事件  参数:具体的项*/\r\n");
      out.write("function menuHandler(item){\r\n");
      out.write("\tvar tree = $(\"#contentCategory\");\r\n");
      out.write("\t//取得当前选中节点\r\n");
      out.write("\tvar node = tree.tree(\"getSelected\");\r\n");
      out.write("\tif(item.name === \"add\"){  //当点增加触发事件\r\n");
      out.write("\t\ttree.tree('append', {//添加新的节点\r\n");
      out.write("            parent: (node?node.target:null),\r\n");
      out.write("            data: [{  //新增节点的对象 3个属性EasyUITreeNode对象匹配\r\n");
      out.write("                text: '新建分类',\r\n");
      out.write("                id : 0,\r\n");
      out.write("                parentId : node.id\r\n");
      out.write("            }]\r\n");
      out.write("        }); \r\n");
      out.write("\t\tvar _node = tree.tree('find',0);//根节点 新增的节点id都为0\r\n");
      out.write("\t\ttree.tree(\"select\",_node.target).tree('beginEdit',_node.target);\t//变成可编辑状态\r\n");
