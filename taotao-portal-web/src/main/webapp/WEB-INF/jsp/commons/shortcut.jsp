...
<div id="shortcut-2013">
	<div class="w">
		...
		<ul class="fr lh">
			<li class="fore1" id="loginbar" clstag="homepage|keycount|home2013|01b">您好！欢迎来到图书网购商城！<a href="javascript:login()">[登录]</a>&nbsp;<a href="javascript:regist()">[免费注册]</a></li>
			<li class="fore2 ld" clstag="homepage|keycount|home2013|01c">
				<s></s>
				<a id="myOrder" href="http://localhost:8088/user?userid=" rel="nofollow">我的订单</a>
			</li>
